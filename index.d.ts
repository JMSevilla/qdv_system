...
export type ComposedStyleFunction<T extends Array<StyleFunction<any>>> =
  StyleFunction<ComposedStyleProps<T>>;
...
export function css<Props>(
  ...
  Props & { css?: Omit<Props, "theme">; sx?: Omit<Props, "theme"> }
>;

export function styleFunctionSx<Props>(
  styleFunction: StyleFunction<Props>
): StyleFunction<
  Props & { sx?: Omit<Props, "theme">; css?: Omit<Props, "theme"> }
>;
...
export const text: SimpleStyleFunction<
  | "fontFamily"
  | "fontSize"
  | "fontStyle"
  | "fontWeight"
  ...
  | "textAlign"
>;
export type TextProps = PropsFor<typeof text>;
